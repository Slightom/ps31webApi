...
class App extends Component {
  ...
  componentDidMount(){
    return fetch("https://www.googleapis.com/youtube/v3/search?key="+API.YOUTUBE_API+"&channelId=UC-KTRBl9_6AX10-Y7IKwKdw&part=snippet,id&order=date&maxResults=20")
